...
<svg xmlns="http://www.w3.org/2000/svg" class="min-w-full min-h-full" clip-rule="evenodd" fill-rule="evenodd"
    image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision"
    version="1.1" viewBox="0 0 67733 38100">
    <defs>
        <style type="text/css">
            .fil167 {
                fill: url(#kh);
